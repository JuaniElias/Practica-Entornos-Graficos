    ...
    ?>
        <table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            foreach ($carro as $k => $v) {
                ...
                $contador++;
            ?>
                <form name="a<?php echo $v['identificador'] ?>" method="post" action="agregar-carrito.php?<?php echo SID ?>" id="a<?php echo $v['identificador'] ?>">
                    <tr bgcolor="<?php echo $color[$contador % 2]; ?>" class='prod'>
                        ...
                        <td align="center">
                            <a href="borrarcar.php?<?php echo SID ?>&id=<?php echo $v['id'] ?>">
