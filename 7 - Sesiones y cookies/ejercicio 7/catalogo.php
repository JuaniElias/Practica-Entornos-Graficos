...
$qry = mysqli_query($link, "select * from productos order by producto asc");
?>
<html>
...
solid #000000;">
        ...
        ?>
            <tr valign="middle" class="catalogo">
                ...
                {
                ?>
                <a href="agregar-carrito.php"<?php echo SID ?>&id=<?php echo $row['id'];
                ?>"><img src="productonoagregado.gif" border="0" title="Agregar al Carrito"></a>
                <?php } else { ?>
